...
extern "C" {
    __declspec(dllexport) void __cdecl Control (double *position, double *velocity, double *action, int numAxis, double *wayPointX, double *wayPointY, int numWaypoints, double *actualWayPoint, double *param, int numParam)
	{
		...
		{
		MatrAt[0][0]=MatrAt[0][0]/eps;
		MatrAt[0][1]=MatrAt[0][1]/eps;
		MatrAt[1][0]=MatrAt[1][0]/eps;
		MatrAt[1][1]=MatrAt[1][1]/eps;
		}
		...
		Tix = 0;
		Tdx = 0.05;
		int Nx = 12; PID para ejes cambiados*/
		Kcx = 1.5;
		Tix = 0;
		Tdx = 3;
		int Nx = 20;
		...
		Tiy = 0;
		Tdy = 3;
		int Ny = 20; PID para ejes cambiados*/
		Kcy = 0.1;
		Tiy = 0;
		Tdy = 0.2;
		int Ny = 16; //PID para final, a tirones
		/*Kcy = 0.1;
		Tiy = 0;
		Tdy = 0.05;
		int Ny = 12;*/
