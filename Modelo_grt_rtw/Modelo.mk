...
MODEL                = Modelo
MODULES              = Modelo_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             = Modelo.mk
...
MODELLIB                  = Modelolib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Modelo_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Modelo_grt_rtw
