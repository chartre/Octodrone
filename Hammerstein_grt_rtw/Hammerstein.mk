...
MODEL                = Hammerstein
MODULES              = Hammerstein_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             = Hammerstein.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = C:\Users\Carlos\Documents\GitHub\Octodrone
S_FUNCTIONS          = sfunpwlinear.c eval_pwlinear.c
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 1
TID01EQ              = 0
...
SHARED_LIB           = 
TARGET_LANG_EXT      = c
MEX_OPT_FILE         = -f C:\Users\Carlos\AppData\Roaming\MATHWO~1\MATLAB\R2012b\mexopts.bat
VISUAL_VER           = 10.0
...
MODELLIB                  = Hammersteinlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Hammerstein_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Hammerstein_grt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\ident\idutils\src
...
{$(MATLAB_ROOT)\toolbox\ident\idutils\src}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
...
{$(MATLAB_ROOT)\toolbox\ident\idutils\src}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<
