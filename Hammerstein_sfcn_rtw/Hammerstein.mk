...
MODEL              = Hammerstein
MODULES            = Hammerstein_sf_data.c rtGetInf.c rtGetNaN.c 
...
MEM_ALLOC          = RT_STATIC
MEXEXT             = mexw64
BUILDARGS          =  GENERATE_REPORT=0 MODELLIB=Hammersteinlib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE
CREATEMODEL        = 1
USERMODULES        =  
USEPARAMVALUES     = 0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Hammerstein_sfcn_rtw
